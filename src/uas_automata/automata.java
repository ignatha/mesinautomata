...
public class automata extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        mesin m = new mesin();
        m.setInput(jTextField2.getText());
        m.jalankan();
        String hasil="";
        for (String log : m.getLog()) {
            if(log != null)
            hasil += log + "\n";
        }
        ...
        if(m.getOutput()){
            jTextField3.setBackground(new Color(231, 255, 221));
            jTextField3.setText("Accepted");
        }else{
            jTextField3.setBackground(new Color(255, 227, 221));
